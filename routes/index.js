...
router.get('/search/results', function(req, res, next) {
  ...
  var encodedPath = `https://api.nal.usda.gov/ndb/search/?format=json&q=${encodedQuery}&ds=Standard%20Reference&sort=n&max=50&offset=0&api_key=otG2SftWm3WXimTE3iX2OznAWtnHaCB7spWhwEjo`
